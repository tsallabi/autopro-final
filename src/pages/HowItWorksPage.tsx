        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white" dir="rtl">
            ...
            <section className="py-20 px-6">
                <div className="max-w-3xl mx-auto">
                    ...
                    {[
                        { q: 'كم الحد الأدنى للعربون/الإيداع؟', a: 'الحد الأدنى خارج ليبيا $500 دولار، وداخل ليبيا 1,000 دينار ليبي. القوة الشرائية = العربون × 10. مثال: إيداع $500 = قوة شرائية $5,000.' },
